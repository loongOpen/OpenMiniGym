...
def callback(data):
    ...
    if len(points_array) <800:
        clustering = DBSCAN(eps=0.025, min_samples=40).fit(points_array)
        ...
        for label, center, distance in clusters:
            ...
            # print(t.child_frame_id,":",t.transform)

            # print("{}: Translation: {}, {}, {} Rotation in Euler: Roll={}, Pitch={}, Yaw={}".format(
            #     t.child_frame_id,
...
def listener():
    ...
    rospy.Subscriber("/downsampled_points", PointCloud2, callback, queue_size=1)
    rospy.spin()
