...
#define DISPLAY_RECTANGLE_Y_OFFSET 0
#define DISPLAY_WIDTH 200
#define DISPLAY_HEIGHT 110
#define DISPLAY_MAX_RANGE 40
#define DISPLAY_CIRCLE_SIZE 2
...
//        2 * DISPLAY_MAX_RANGE + 2, DISPLAY_MAX_RANGE + 2);
    wb_display_draw_text(display, "Lidar", DISPLAY_RECTANGLE_Y_OFFSET, DISPLAY_RECTANGLE_Y_OFFSET);
    wb_display_set_color(display, BLUE);
    wb_display_fill_oval(display, DISPLAY_WIDTH / 2, (DISPLAY_HEIGHT) / 2 + DISPLAY_RECTANGLE_Y_OFFSET,
