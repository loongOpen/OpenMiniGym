...
void state_estimator(float dt)//guji
{
    ...
    robotwb.base_vel_b_w_fushion=robotwb.base_vel_b_w;
    ...
    robotwb.base_rate_w=(w_r-w_l)*robotwb.wheel_w;
...
//    printf("yaw_rate: w=%f imu=%f fushion=%f\n",robotwb.base_rate_w,robotwb.base_rate_imu,robotwb.base_rate_fushion);
    //Kf fushion
...
#if 0
    printf("base_vel[%d]: b=%f\n",robotwb.wheel_touch_cnt,robotwb.base_vel_b_w.x);
