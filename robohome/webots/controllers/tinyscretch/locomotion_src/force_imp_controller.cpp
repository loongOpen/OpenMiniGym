...
void force_control_and_dis_pose(float dt)//底层==>位力混控制  站立步态！！
{
    ...
    if(robotwb.state_gait==2){
        ...
        //IK output
        float kp_gain=0.015;
        robotwb.arm_epos_h_exp_flt.x+=LIMIT(robotwb.arm_epos_h_exp.x-robotwb.arm_epos_h_exp_flt.x,-0.1,0.1)*kp_gain;
        robotwb.arm_epos_h_exp_flt.y+=LIMIT(robotwb.arm_epos_h_exp.y-robotwb.arm_epos_h_exp_flt.y,-0.1,0.1)*kp_gain;
        robotwb.arm_epos_h_exp_flt.z+=LIMIT(robotwb.arm_epos_h_exp.z-robotwb.arm_epos_h_exp_flt.z,-0.1,0.1)*kp_gain;
        ...
        END_POS end_att;
        end_att.x=robotwb.arm_att_h_exp.x/57.3;
        end_att.y=robotwb.arm_att_h_exp.y/57.3;
        end_att.z=robotwb.arm_att_h_exp.z/57.3;
        float q_out[6]={0};
