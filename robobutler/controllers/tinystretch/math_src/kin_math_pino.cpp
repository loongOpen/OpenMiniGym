...
#include <iostream>
#define ARM_URDF "/home/pi/Documents/tinystrech/protos/TinyStretch/urdf/TinyStretch_arm.urdf"
...
//        if(itr_count==0)
//         std::cout<<"pino:"<<std::endl<<J<<std::endl;
