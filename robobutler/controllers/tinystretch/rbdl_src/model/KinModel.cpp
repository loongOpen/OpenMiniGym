...
const char* link_name[] =
{
    ...
    "arm0_link","arm1_link","arm2_link","arm3_link","arm4_link"
};
...
unsigned int KinModel::_find_body_idx(int id) const {//doghome
    switch(id){
        case robot_link::base_link:
            return model_->GetBodyId("base_link");
        case robot_link::arm_base_link:
            return model_->GetBodyId("arm_base_link");
        case robot_link::arm3_link:
            return model_->GetBodyId("arm3_link");
        case robot_link::arm4_link:
            return model_->GetBodyId("arm4_link");
        default:
            std::cout << "unkonown id:" <<id<< std::endl;
    }
    return 0;
}
