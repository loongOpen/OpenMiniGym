...
// 2x1 Vector
template <typename T>
using Vec2m = typename Eigen::Matrix<T, 2, 1>;

// 3x1 Vector
template <typename T>
using Vec3m = typename Eigen::Matrix<T, 3, 1>;

// 4x1 Vector
template <typename T>
using Vec4m = typename Eigen::Matrix<T, 4, 1>;

// 5x1 Vector
template <typename T>
using Vec5m = typename Eigen::Matrix<T, 5, 1>;
...
// 3x3 Matrix
template <typename T>
using Mat3m = typename Eigen::Matrix<T, 3, 3>;
