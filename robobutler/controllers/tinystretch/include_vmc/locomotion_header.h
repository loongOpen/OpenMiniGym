...
int ik_rbdl(END_POS end_pos,END_POS end_att,float q_out[6]);
//----------------------------------------
...
extern float min_q0[3];
extern float max_q0[3];
extern float min_q1[3];
extern float max_q1[3];
extern float min_q2[3];
extern float max_q2[3];
