...
now_cog_z=limit(data(:,11),-0.5,0.5);
...
leg0_dq0_now=    data(:,cnt);cnt=cnt+1;
leg0_dq1_now=    data(:,cnt);cnt=cnt+1;
leg0_dq2_now=    data(:,cnt);cnt=cnt+1;
leg0_dq3_now=    data(:,cnt);cnt=cnt+1;
leg0_dq4_now=    data(:,cnt);cnt=cnt+1;
...
leg1_dq0_now=    data(:,cnt);cnt=cnt+1;
leg1_dq1_now=    data(:,cnt);cnt=cnt+1;
leg1_dq2_now=    data(:,cnt);cnt=cnt+1;
leg1_dq3_now=    data(:,cnt);cnt=cnt+1;
leg1_dq4_now=    data(:,cnt);cnt=cnt+1;
...
hold on;
plot(leg0_t0_tar(P_ST:P_END),'-.r','LineWidth',2);
ylabel('大腿扭矩');
grid on;
subplot(3,5,14);
plot(leg0_t1_now(P_ST:P_END),'-k','LineWidth',2);
hold on;
plot(leg0_t1_tar(P_ST:P_END),'-.r','LineWidth',2);
ylabel('小腿扭矩');
grid on;
