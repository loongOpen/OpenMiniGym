...
from robomimic.robomimic.models.base_nets import ResNet18Conv, SpatialSoftmax
from robomimic.robomimic.algo.diffusion_policy import replace_bn_with_gn, ConditionalUnet1D
