#录制数据   数据长度在constants中 录制话题在robot_utils
import os
import time
import h5py
import argparse
        ...
        for cam_name in camera_names:
            if COMPRESS:
                ...
                _ = image.create_dataset(cam_name, (max_timesteps, 480, 640, 3), dtype='uint8',
                                         chunks=(1, 480, 640, 3), )
        _ = obs.create_dataset('qpos', (max_timesteps, (DOF_ARM+DOF_CAP)*HAND_NUM))#dof all
        _ = obs.create_dataset('qvel', (max_timesteps, (DOF_ARM+DOF_CAP)*HAND_NUM))
        _ = obs.create_dataset('effort', (max_timesteps, (DOF_ARM+DOF_CAP)*HAND_NUM))
        _ = root.create_dataset('action', (max_timesteps, (DOF_ARM+DOF_CAP)*HAND_NUM))
