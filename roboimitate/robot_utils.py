...
class ImageRecorder:
    def __init__(self, init_node=True, is_debug=False):
        ...
        for cam_name in self.camera_names:
            ...
            rospy.Subscriber(f"/{cam_name}/image_raw", Image, callback_func)
            print(f"/{cam_name}/image_raw")
            if self.is_debug:
...
class Recorder:
    def __init__(self, side, init_node=True, is_debug=False):
        ...
        print(f"/puppet_{side}/joint_states")
        rospy.init_node('recorder', anonymous=True)
        rospy.Subscriber(f"/puppet_{side}_exp/joint_states", JointState, self.puppet_arm_commands_cb)
        if self.is_debug:
